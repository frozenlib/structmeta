...
In the auto-generated implementation, [`quote::ToTokens::to_tokens`] is called for all fields in order from the top.
...
Specifies the start or end of brace, bracket, paren.

See [`#[derive(ToTokens)]`](macro@ToTokens) documentation for more details.
